...
public class returnBook extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 130, 200, -1));
        ...
        getContentPane().add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 230, 200, -1));
...
try
{
    ...
    Statement stm=con.createStatement();
     ResultSet rs= stm.executeQuery("select *from issue where bookID='"+bookID+"'and studentID='"+studentID+"'");
     if(rs.next())
     {
         jTextField3.setText(rs.getString(3));
           jTextField4.setText(rs.getString(4));
         jTextField1.setEditable(false);//after searching if book is issued the we cannot change the book and student id
...
try
{
    Connection con = connection.getCon();
    Statement stm=con.createStatement(); 
    stm.executeUpdate("update issue set returnBook='YES' where studentID='"+ studentID+"'and bookID='"+bookID+"'");
